var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},t={},a={},r=e.parcelRequire6c15;null==r&&((r=function(e){if(e in t)return t[e].exports;if(e in a){var r=a[e];delete a[e];var i={id:e,exports:{}};return t[e]=i,r.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){a[e]=t},e.parcelRequire6c15=r),r.register("gPNMe",function(e,t){e.exports=new URL(r("27Lyk").resolve("dCh8C"),import.meta.url).toString()}),r.register("bV7Mj",function(e,t){e.exports=new URL(r("27Lyk").resolve("dTl3G"),import.meta.url).toString()}),r.register("6DNN2",function(e,t){e.exports=new URL(r("27Lyk").resolve("kQqv5"),import.meta.url).toString()}),r.register("3lHJf",function(e,t){e.exports=new URL(r("27Lyk").resolve("458Cq"),import.meta.url).toString()}),r.register("3vCYr",function(e,t){e.exports=new URL(r("27Lyk").resolve("iKwvN"),import.meta.url).toString()}),r.register("6uJzw",function(e,t){e.exports=new URL(r("27Lyk").resolve("8op45"),import.meta.url).toString()});class i extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}connectedCallback(){}render(){let e=r("gPNMe"),t=r("bV7Mj"),a=r("6DNN2");this.shadow.innerHTML=`
      ...
      `,this.shadow.appendChild(t)}}function c(e){return Array.isArray(e=e||[])?e:[e]}function l(e){return`[Vaadin.Router] ${e}`}customElements.define("contact-page",o);const d="module",p="nomodule",h=[d,p];function m(e){if(!e.match(/.+\.[m]?js$/))throw Error(l(`Unsupported type for bundle "${e}": .js or .mjs expected.`))}function g(e){if(!e||!_(e.path))throw Error(l('Expected route config to be an object with a "path" string property, or an array of such objects'));let t=e.bundle,a=["component","redirect","bundle"];if(!x(e.action)&&!Array.isArray(e.children)&&!x(e.children)&&!w(t)&&!a.some(t=>_(e[t])))throw Error(l(`Expected route config "${e.path}" to include either "${a.join('", "')}" or "action" function but none found.`));if(t){if(_(t))m(t);else if(h.some(e=>e in t))h.forEach(e=>e in t&&m(t[e]));else throw Error(l('Expected route bundle to include either "'+p+'" or "'+d+'" keys, or both'))}e.redirect&&["bundle","component"].forEach(t=>{t in e&&console.warn(l(`Route config "${e.path}" has both "redirect" and "${t}" properties, and "redirect" will always override the latter. Did you mean to only use "${t}"?`))})}function u(e){c(e).forEach(e=>g(e))}function v(e,t){let a=document.head.querySelector('script[src="'+e+'"][async]');return a||((a=document.createElement("script")).setAttribute("src",e),t===d?a.setAttribute("type",d):t===p&&a.setAttribute(p,""),a.async=!0),new Promise((e,t)=>{a.onreadystatechange=a.onload=t=>{a.__dynamicImportLoaded=!0,e(t)},a.onerror=e=>{a.parentNode&&a.parentNode.removeChild(a),t(e)},null===a.parentNode?document.head.appendChild(a):a.__dynamicImportLoaded&&e()})}function f(e,t){return!window.dispatchEvent(new CustomEvent(`vaadin-router-${e}`,{cancelable:"go"===e,detail:t}))}function w(e){// guard against null passing the typeof check
return"object"==typeof e&&!!e}function x(e){return"function"==typeof e}function _(e){return"string"==typeof e}function b(e){let t=Error(l(`Page not found (${e.pathname})`));return t.context=e,t.code=404,t}const y=new class{};// The list of checks is not complete:
 ...
 * @param  {Object=} options
 * @return {!RegExp}
 */function(t,a,r){for(var i=[],s=0;s<t.length;s++)i.push(e(t[s],a,r).source);return RegExp("(?:"+i.join("|")+")",j(r))}(/** @type {!Array} */t,a,r):A(M(/** @type {string} */t,r),a,r)},z=RegExp("(\\\\.)|(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?","g");/**
...
if(n+=e.slice(s,h),s=h+d.length,p){n+=p[1],l=!0;continue}var m="",g=e[s],u=a[2],v=a[3],f=a[4],w=a[5];if(!l&&n.length){var x=n.length-1;c.indexOf(n[x])>-1&&(m=n[x],n=n.slice(0,x))}n&&(r.push(n),n="",l=!1);var _=""!==m&&void 0!==g&&g!==m,b="+"===w||"*"===w,y="?"===w||"*"===w,k=m||o,C=v||f;r.push({name:u||i++,prefix:m,delimiter:k,optional:y,repeat:b,partial:_,pattern:C?C.replace(/([=!:$/()])/g,"\\$1"):"[^"+H(k)+"]+?"})}return(n||s<e.length)&&r.push(n+e.substr(s)),r}/**
...
this.__createdByRouter=new WeakMap,this.__addedByRouter=new WeakMap}__resolveRoute(e){let t=e.route,a=Promise.resolve();x(t.children)&&(a=a.then(()=>t.children(function(e){let t=Object.assign({},e);return delete t.next,t}(e))).then(e=>{null!=e||x(t.children)||(e=t.children),function(e,t){if(!Array.isArray(e)&&!w(e))throw Error(l(`Incorrect "children" value for the route ${t.path}: expected array or object, but got ${e}`));t.__children=[];let a=c(e);for(let e=0;e<a.length;e++)g(a[e]),t.__children.push(a[e])}(e,t)}));let r={redirect:t=>W(e,t),component:e=>{let t=document.createElement(e);return this.__createdByRouter.set(t,!0),t}};return a.then(()=>{if(this.__isLatestRender(e))return G(t.action,[e,r],t)}).then(e=>{var a;return null!=e&&(e instanceof HTMLElement||e.redirect||e===y)?e:_(t.redirect)?r.redirect(t.redirect):t.bundle?(_(a=t.bundle)?v(a):Promise.race(h.filter(e=>e in a).map(e=>v(a[e],e)))).then(()=>{},()=>{throw Error(l(`Bundle not found: ${t.bundle}. Check if the file name is correct`))}):void 0}).then(e=>null!=e?e:_(t.component)?r.component(t.component):void 0)}/**
...
this.listeners.push(e)},getState(){return this.data},setHeader(e){let t=this.getState();t.actualTabHeader=e,this.setState(t)},setState(e){this.data=e;let t=this.getState();for(let e of this.listeners)e(t)}};class es extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}connectedCallback(){}render(){let e=this.getAttribute("title");var t="",a="Preview tarjeta...";switch(e){case"Sobre Mi":a="Informacion sobre Sebas",t=r("bV7Mj");break;case"Experiencias":a="Experiencias laborales",t=r("3lHJf");break;case"Trabajos":a="Proyectos web",t=r("3vCYr");break;case"Contacto":a="Encontrame en...",t=r("6uJzw")}this.addEventListener("click",()=>{switch(e){case"Sobre Mi":Z.go("/"),ei.setHeader("Sobre m\xed");break;case"Experiencias":Z.go("/experiences"),ei.setHeader("Experiencias");break;case"Trabajos":Z.go("/works"),ei.setHeader("Trabajos");break;case"Contacto":Z.go("/contact"),ei.setHeader("Contacto")}}),this.shadow.innerHTML=`
      ...
      `,this.shadow.appendChild(e)}}customElements.define("chat-header",en);const eo=new Z(document.querySelector(".main__container"));eo.setRoutes([{path:"/",component:"about-page"},{path:"/experiences",component:"exp-page"},{path:"/works",component:"works-page"},{path:"/contact",component:"contact-page"}]),console.log("Index HOLA");//# sourceMappingURL=index.dd40a246.js.map

//# sourceMappingURL=index.dd40a246.js.map
