...
this.listeners.push(e)},getState(){return this.data},setDeployedStatus(e){let t=this.getState();t.deployed=e,this.setState(t)},setHeader(e){let t=this.getState();t.actualTabHeader=e,this.setState(t)},setState(e){this.data=e;let t=this.getState();for(let e of this.listeners)e(t)}};class es extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}connectedCallback(){}render(){let e=this.getAttribute("title");var t="",a="Preview tarjeta...";switch(e){case"Sobre Mi":a="Informacion sobre Sebas",t=r("bV7Mj");break;case"Experiencias":a="Experiencias laborales",t=r("3lHJf");break;case"Trabajos":a="Proyectos web",t=r("3vCYr");break;case"Contacto":a="Encontrame en...",t=r("6uJzw")}this.addEventListener("click",()=>{let t=en.getState();if(t.deployed)switch(e){case"Sobre Mi":ee.go("/wpp-clon/about"),en.setHeader("Sobre m\xed");break;case"Experiencias":ee.go("/wpp-clon/experiences"),en.setHeader("Experiencias");break;case"Trabajos":ee.go("/wpp-clon/works"),en.setHeader("Trabajos");break;case"Contacto":ee.go("/wpp-clon/contact"),en.setHeader("Contacto")}if(!t.deployed)switch(e){case"Sobre Mi":ee.go("/about"),en.setHeader("Sobre m\xed");break;case"Experiencias":ee.go("/experiences"),en.setHeader("Experiencias");break;case"Trabajos":ee.go("/works"),en.setHeader("Trabajos");break;case"Contacto":ee.go("/contact"),en.setHeader("Contacto")}}),this.shadow.innerHTML=`
      ...
      `,this.shadow.appendChild(e)}}customElements.define("chat-header",eo);const ec=new ee(document.querySelector(".main__container")),el=en.getState();el.deployed?el.deployed&&ec.setRoutes([{path:"/wpp-clon/",component:"about-page"},{path:"/wpp-clon/about",component:"about-page"},{path:"/wpp-clon/experiences",component:"exp-page"},{path:"/wpp-clon/works",component:"works-page"},{path:"/wpp-clon/contact",component:"contact-page"}]):ec.setRoutes([{path:"/",component:"home-page"},{path:"/about",component:"about-page"},{path:"/experiences",component:"exp-page"},{path:"/works",component:"works-page"},{path:"/contact",component:"contact-page"}]),console.log("Index HOLA");//# sourceMappingURL=index.02bcdfe3.js.map

//# sourceMappingURL=index.02bcdfe3.js.map
