...
let{pathname:i,search:s,hash:n}=t;f("go",{pathname:i,search:s,hash:n})&&(e.preventDefault(),e&&"click"===e.type&&window.scrollTo(0,0))}// PopStateEvent constructor shim
const C=/Trident/.test(navigator.userAgent);function E(e){if("vaadin-router-ignore"===e.state)return;let{pathname:t,search:a,hash:r}=window.location;f("go",{pathname:t,search:a,hash:r})}C&&!x(window.PopStateEvent)&&(window.PopStateEvent=function(e,t){t=t||{};var a=document.createEvent("Event");return a.initEvent(e,!!t.bubbles,!!t.cancelable),a.state=t.state||null,a},window.PopStateEvent.prototype=window.Event.prototype);/**
 * Expose `pathToRegexp`.
 */var L=/**
 ...
 * @param  {Object=} options
 * @return {!RegExp}
 */function(t,a,r){for(var i=[],s=0;s<t.length;s++)i.push(e(t[s],a,r).source);return RegExp("(?:"+i.join("|")+")",j(r))}(/** @type {!Array} */t,a,r):T(M(/** @type {string} */t,r),a,r)},z=RegExp("(\\\\.)|(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?","g");/**
 * Parse a string for the raw tokens.
 *
 * @param  {string}  str
 * @param  {Object=} options
 * @return {!Array}
 */function M(e,t){for(var a,r=[],i=0,s=0,n="",o=t&&t.delimiter||"/",c=t&&t.delimiters||"./",l=!1;null!==(a=z.exec(e));){var d=a[0],p=a[1],h=a.index;// Ignore already escaped sequences.
if(n+=e.slice(s,h),s=h+d.length,p){n+=p[1],l=!0;continue}var m="",g=e[s],u=a[2],v=a[3],f=a[4],w=a[5];if(!l&&n.length){var x=n.length-1;c.indexOf(n[x])>-1&&(m=n[x],n=n.slice(0,x))}n&&(r.push(n),n="",l=!1);var b=""!==m&&void 0!==g&&g!==m,_="+"===w||"*"===w,y="?"===w||"*"===w,k=m||o,C=v||f;r.push({name:u||i++,prefix:m,delimiter:k,optional:y,repeat:_,partial:b,pattern:C?C.replace(/([=!:$/()])/g,"\\$1"):"[^"+H(k)+"]+?"})}return(n||s<e.length)&&r.push(n+e.substr(s)),r}/**
...
for(var r=(a=a||{}).strict,i=!1!==a.start,s=!1!==a.end,n=H(a.delimiter||"/"),o=a.delimiters||"./",c=[].concat(a.endsWith||[]).map(H).concat("$").join("|"),l=i?"^":"",d=0===e.length,p=0;p<e.length;p++){var h=e[p];if("string"==typeof h)l+=H(h),d=p===e.length-1&&o.indexOf(h[h.length-1])>-1;else{var m=h.repeat?"(?:"+h.pattern+")(?:"+H(h.delimiter)+"(?:"+h.pattern+"))*":h.pattern;t&&t.push(h),h.optional?h.partial?l+=H(h.prefix)+"("+m+")?":l+="(?:"+H(h.prefix)+"("+m+"))?":l+=H(h.prefix)+"("+m+")"}}return s?(r||(l+="(?:"+n+")?"),l+="$"===c?"$":"(?="+c+")"):(r||(l+="(?:"+n+"(?="+c+"))?"),d||(l+="(?="+n+"|"+c+")")),new RegExp(l,j(a))}L.parse=M,L.compile=/**
 * Compile a string to a template function for the path.
 *
 * @param  {string}             str
 * @param  {Object=}            options
 * @return {!function(Object=, Object=)}
 */function(e,t){return R(M(e,t))},L.tokensToFunction=R,L.tokensToRegExp=T;/**
 ...
 */const{hasOwnProperty:A}=Object.prototype,S=new Map;function P(e){try{return decodeURIComponent(e)}catch(t){return e}}/**
 * Universal Router (https://www.kriasoft.com/universal-router/)
 *
 * Copyright (c) 2015-present Kriasoft.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE.txt file in the root directory of this source tree.
 */function O(e){if(x(e.route.action))return e.route.action(e)}// see https://github.com/pillarjs/path-to-regexp/issues/148
S.set("|false",{keys:[],pattern:/(?:)/});/**
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE.txt file in the root directory of this source tree.
 */function(e,t){let a=t;for(;a;)if((a=a.parent)===e)return!0;return!1}(c,i.value.route)))?(s=i,Promise.resolve(y)):i.done?Promise.reject(_(t)):(!function(e,t){let{route:a,path:r}=t;if(a&&!a.__synthetic){if(e.chain){if(a.parent){let t=e.chain.length;for(;t--&&e.chain[t].route&&e.chain[t].route!==a.parent;)e.chain.pop()}}else e.chain=[];e.chain.push({path:r,route:a})}}(n=Object.assign(n?{chain:n.chain?n.chain.slice(0):[]}:{},t,i.value),i.value),Promise.resolve(r(n)).then(t=>null!=t&&t!==y?(n.result=t.result||t,n):o(e,c,t)))}return t.next=o,Promise.resolve().then(()=>o(!0,this.root)).catch(e=>{let t=function(e){let t=`Path '${e.pathname}' is not properly resolved due to an error.`,a=(e.route||{}).path;return a&&(t+=` Resolution had failed on route: '${a}'`),t}(n);if(e?console.warn(t):e=Error(t),e.context=e.context||n,e instanceof DOMException||(e.code=e.code||500),this.errorHandler)return n.result=this.errorHandler(e),n;throw e})}/**
   ...
   */__normalizePathname(e){if(!this.baseUrl)return e;let t=this.__effectiveBaseUrl,a=this.constructor.__createUrl(e,t).href;if(a.slice(0,t.length)===t)return a.slice(t.length)}}$.pathToRegexp=L;/**
 * Universal Router (https://www.kriasoft.com/universal-router/)
 *
 * Copyright (c) 2015-present Kriasoft.
 *
 ...
 *//** @type {Array<NavigationTrigger>} */let F=[];const D=e=>{let t=getComputedStyle(e).getPropertyValue("animation-name");return t&&"none"!==t},V=(e,t)=>{let a=()=>{e.removeEventListener("animationend",a),t()};e.addEventListener("animationend",a)};function q(e,t){return e.classList.add(t),new Promise(a=>{if(D(e)){let r=e.getBoundingClientRect(),i=`height: ${r.bottom-r.top}px; width: ${r.right-r.left}px`;e.setAttribute("style",`position: absolute; ${i}`),V(e,()=>{e.classList.remove(t),e.removeAttribute("style"),a()})}else e.classList.remove(t),a()})}function J({pathname:e="",search:t="",hash:a="",chain:r=[],params:i={},redirectFrom:s,resolver:n},o){let c=r.map(e=>e.route);return{baseUrl:n&&n.baseUrl||"",pathname:e,search:t,hash:a,routes:c,route:o||c.length&&c[c.length-1]||null,params:i,redirectFrom:s,getUrl:(e={})=>Y(Z.pathToRegexp.compile(X(c))(Object.assign({},i,e)),n)}}function W(e,t){let a=Object.assign({},e.params);return{redirect:{pathname:t,from:e.pathname,params:a}}}function G(e,t,a){if(x(e))return e.apply(a,t)}function K(e,t,a){return r=>r&&(r.cancel||r.redirect)?r:a?G(a[e],t,a):void 0}function Q(e){if(e&&e.length){let t=e[0].parentNode;for(let a=0;a<e.length;a++)t.removeChild(e[a])}}function Y(e,t){let a=t.__effectiveBaseUrl;return a?t.constructor.__createUrl(e.replace(/^\//,""),a).pathname:e}function X(e){return e.map(e=>e.path).reduce((e,t)=>t.length?e.replace(/\/$/,"")+"/"+t.replace(/^\//,""):e,"")}/**
...
for(let t=e.__divergedChainIndex;t<e.chain.length&&this.__isLatestRender(e);t++){let a=e.chain[t].element||{},r=J(e,e.chain[t].route);G(a.onAfterEnter,[r,{},e.resolver],a)}}__animateIfNeeded(e){let t;let a=(this.__disappearingContent||[])[0],r=(this.__appearingContent||[])[0],i=[],s=e.chain;for(let e=s.length;e>0;e--)if(s[e-1].route.animate){t=s[e-1].route.animate;break}if(a&&r&&t){let e=w(t)&&t.leave||"leaving",s=w(t)&&t.enter||"entering";i.push(q(a,e)),i.push(q(r,s))}return Promise.all(i).then(()=>e)}/**
   ...
   *
   * @return {string}
   */urlForName(e,t){return this.__urlForName||(this.__urlForName=function(e,t={}){if(!(e instanceof $))throw TypeError("An instance of Resolver is expected");let a=new Map;return(r,i)=>{let s=I(a,r);if(!s&&(a.clear(),function e(t,a,r){let i=a.name||a.component;if(i&&(t.has(i)?t.get(i).push(a):t.set(i,[a])),Array.isArray(r))for(let i=0;i<r.length;i++){let s=r[i];s.parent=a,e(t,s,s.__children||s.children)}}(a,e.root,e.root.__children),!(s=I(a,r))))throw Error(`Route "${r}" not found`);let n=N.get(s.fullPath);if(!n){let e=U(s),t=s.parent;for(;t;){let a=U(t);a&&(e=a.replace(/\/$/,"")+"/"+e.replace(/^\//,"")),t=t.parent}let a=B.parse(e),r=B.tokensToFunction(a),i=Object.create(null);for(let e=0;e<a.length;e++)b(a[e])||(i[a[e].name]=!0);n={toPath:r,keys:i},N.set(e,n),s.fullPath=e}let o=n.toPath(i,t)||"/";if(t.stringifyQueryParams&&i){let e={},a=Object.keys(i);for(let t=0;t<a.length;t++){let r=a[t];n.keys[r]||(e[r]=i[r])}let r=t.stringifyQueryParams(e);r&&(o+="?"===r.charAt(0)?r:`?${r}`)}return o}}(this)),Y(this.__urlForName(e,t),this)}/**
...
try {
  ...
  vaadin-dev-mode:end **/}),Z.NavigationTrigger={POPSTATE:{activate(){window.addEventListener("popstate",E)},inactivate(){window.removeEventListener("popstate",E)}},CLICK:{activate(){window.document.addEventListener("click",k)},inactivate(){window.document.removeEventListener("click",k)}}};const ei={data:{actualTabHeader:"Sobre m\xed",deployed:!1},listeners:[],subscribe(e){// recibe callbacks para ser avisados posteriormente
this.listeners.push(e)},getState(){return this.data},setDeployedStatus(e){let t=this.getState();t.deployed=e,this.setState(t)},setHeader(e){let t=this.getState();t.actualTabHeader=e,this.setState(t)},setState(e){this.data=e;let t=this.getState();for(let e of this.listeners)e(t)}};class es extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}connectedCallback(){}render(){let e=this.getAttribute("title");var t="",a="Preview tarjeta...";switch(e){case"Sobre Mi":a="Informacion sobre Sebas",t=r("bV7Mj");break;case"Experiencias":a="Experiencias laborales",t=r("3lHJf");break;case"Trabajos":a="Proyectos web",t=r("3vCYr");break;case"Contacto":a="Encontrame en...",t=r("6uJzw")}this.addEventListener("click",()=>{let t=ei.getState();if(t.deployed)switch(e){case"Sobre Mi":Z.go("/wpp-clon/"),ei.setHeader("Sobre m\xed");break;case"Experiencias":Z.go("/wpp-clon/experiences"),ei.setHeader("Experiencias");break;case"Trabajos":Z.go("/wpp-clon/works"),ei.setHeader("Trabajos");break;case"Contacto":Z.go("/wpp-clon/contact"),ei.setHeader("Contacto")}if(!t.deployed)switch(e){case"Sobre Mi":Z.go("/"),ei.setHeader("Sobre m\xed");break;case"Experiencias":Z.go("/experiences"),ei.setHeader("Experiencias");break;case"Trabajos":Z.go("/works"),ei.setHeader("Trabajos");break;case"Contacto":Z.go("/contact"),ei.setHeader("Contacto")}}),this.shadow.innerHTML=`
      <div class="card">
      ...
      `,this.shadow.appendChild(i)}}customElements.define("chat-card",es);class en extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.headerTitle="Sobre m\xed",this.render()}connectedCallback(){ei.subscribe(e=>{this.headerTitle=e.actualTabHeader,this.render()})}render(){let e=document.createElement("style");var t="";switch(this.headerTitle){case"Sobre m\xed":t=r("bV7Mj");break;case"Experiencias":t=r("3lHJf");break;case"Trabajos":t=r("3vCYr");break;case"Contacto":t=r("6uJzw")}this.shadow.innerHTML=`
      <div class="header">
      ...
      `,this.shadow.appendChild(e)}}customElements.define("chat-header",en);const eo=new Z(document.querySelector(".main__container"));"localhost:1234"==window.location.host?(ei.setDeployedStatus(!1),eo.setRoutes([{path:"/",component:"about-page"},{path:"/experiences",component:"exp-page"},{path:"/works",component:"works-page"},{path:"/contact",component:"contact-page"}])):(ei.setDeployedStatus(!0),eo.setRoutes([{path:"/wpp-clon/",component:"about-page"},{path:"/wpp-clon/experiences",component:"exp-page"},{path:"/wpp-clon/works",component:"works-page"},{path:"/wpp-clon/contact",component:"contact-page"}])),console.log("Index HOLA");//# sourceMappingURL=index.40adaf63.js.map

//# sourceMappingURL=index.40adaf63.js.map
