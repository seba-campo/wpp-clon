var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},t={},a={},r=e.parcelRequire6c15;null==r&&((r=function(e){if(e in t)return t[e].exports;if(e in a){var r=a[e];delete a[e];var i={id:e,exports:{}};return t[e]=i,r.call(i.exports,i,i.exports),i.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){a[e]=t},e.parcelRequire6c15=r),r.register("gPNMe",function(e,t){e.exports=new URL(r("27Lyk").resolve("dCh8C"),import.meta.url).toString()}),r.register("bV7Mj",function(e,t){e.exports=new URL(r("27Lyk").resolve("dTl3G"),import.meta.url).toString()}),r.register("6DNN2",function(e,t){e.exports=new URL(r("27Lyk").resolve("kQqv5"),import.meta.url).toString()}),r.register("eqTuk",function(e,t){e.exports=new URL(r("27Lyk").resolve("fvEmY"),import.meta.url).toString()}),r.register("3lHJf",function(e,t){e.exports=new URL(r("27Lyk").resolve("458Cq"),import.meta.url).toString()}),r.register("3vCYr",function(e,t){e.exports=new URL(r("27Lyk").resolve("iKwvN"),import.meta.url).toString()}),r.register("6uJzw",function(e,t){e.exports=new URL(r("27Lyk").resolve("8op45"),import.meta.url).toString()});class i extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}connectedCallback(){}render(){let e=document.querySelector(".chat-header");e.style.display="flex";let t=r("gPNMe"),a=r("bV7Mj"),i=r("6DNN2");this.shadow.innerHTML=`
      ...
      `,this.shadow.appendChild(n)}}customElements.define("about-page",i);class n extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}connectedCallback(){}render(){let e=document.querySelector(".chat-header");e.style.display="flex";let t=r("gPNMe");this.shadow.innerHTML=`
      <div class="chat-root-div">
      ...
      `,this.shadow.appendChild(a)}}customElements.define("exp-page",n);class s extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}connectedCallback(){}render(){let e=document.querySelector(".chat-header");e.style.display="flex";let t=r("gPNMe");this.shadow.innerHTML=`
      <div class="chat-root-div">
        <div class="experience">
          <div class="message-head">
            <img class="head-img" src=>
      ...
      `,this.shadow.appendChild(a)}}customElements.define("works-page",s);class o extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}connectedCallback(){}render(){let e=document.querySelector(".chat-header");e.style.display="flex";let t=r("gPNMe"),a=r("eqTuk");this.shadow.innerHTML=`
      <div class="chat-root-div">
        <div class="image-div">
      ...
      `,this.shadow.appendChild(i)}}customElements.define("contact-page",o);class c extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}connectedCallback(){}render(){let e=document.querySelector(".chat-header");e.style.display="none",this.shadow.innerHTML=`
...
let{pathname:i,search:n,hash:s}=t;w("go",{pathname:i,search:n,hash:s})&&(e.preventDefault(),e&&"click"===e.type&&window.scrollTo(0,0))}// PopStateEvent constructor shim
 ...
 * @param  {Object=} options
 * @return {!RegExp}
 */function(t,a,r){for(var i=[],n=0;n<t.length;n++)i.push(e(t[n],a,r).source);return RegExp("(?:"+i.join("|")+")",T(r))}(/** @type {!Array} */t,a,r):j(R(/** @type {string} */t,r),a,r)},M=RegExp("(\\\\.)|(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?","g");/**
 * Parse a string for the raw tokens.
 *
 * @param  {string}  str
 * @param  {Object=} options
 * @return {!Array}
 */function R(e,t){for(var a,r=[],i=0,n=0,s="",o=t&&t.delimiter||"/",c=t&&t.delimiters||"./",l=!1;null!==(a=M.exec(e));){var d=a[0],p=a[1],h=a.index;// Ignore already escaped sequences.
if(s+=e.slice(n,h),n=h+d.length,p){s+=p[1],l=!0;continue}var m="",g=e[n],u=a[2],v=a[3],f=a[4],w=a[5];if(!l&&s.length){var x=s.length-1;c.indexOf(s[x])>-1&&(m=s[x],s=s.slice(0,x))}s&&(r.push(s),s="",l=!1);var b=""!==m&&void 0!==g&&g!==m,_="+"===w||"*"===w,y="?"===w||"*"===w,k=m||o,C=v||f;r.push({name:u||i++,prefix:m,delimiter:k,optional:y,repeat:_,partial:b,pattern:C?C.replace(/([=!:$/()])/g,"\\$1"):"[^"+S(k)+"]+?"})}return(s||n<e.length)&&r.push(s+e.substr(n)),r}/**
...
for(var r=(a=a||{}).strict,i=!1!==a.start,n=!1!==a.end,s=S(a.delimiter||"/"),o=a.delimiters||"./",c=[].concat(a.endsWith||[]).map(S).concat("$").join("|"),l=i?"^":"",d=0===e.length,p=0;p<e.length;p++){var h=e[p];if("string"==typeof h)l+=S(h),d=p===e.length-1&&o.indexOf(h[h.length-1])>-1;else{var m=h.repeat?"(?:"+h.pattern+")(?:"+S(h.delimiter)+"(?:"+h.pattern+"))*":h.pattern;t&&t.push(h),h.optional?h.partial?l+=S(h.prefix)+"("+m+")?":l+="(?:"+S(h.prefix)+"("+m+"))?":l+=S(h.prefix)+"("+m+")"}}return n?(r||(l+="(?:"+s+")?"),l+="$"===c?"$":"(?="+c+")"):(r||(l+="(?:"+s+"(?="+c+"))?"),d||(l+="(?="+s+"|"+c+")")),new RegExp(l,T(a))}z.parse=R,z.compile=/**
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE.txt file in the root directory of this source tree.
 */function(e,t){let a=t;for(;a;)if((a=a.parent)===e)return!0;return!1}(c,i.value.route)))?(n=i,Promise.resolve(k)):i.done?Promise.reject(y(t)):(!function(e,t){let{route:a,path:r}=t;if(a&&!a.__synthetic){if(e.chain){if(a.parent){let t=e.chain.length;for(;t--&&e.chain[t].route&&e.chain[t].route!==a.parent;)e.chain.pop()}}else e.chain=[];e.chain.push({path:r,route:a})}}(s=Object.assign(s?{chain:s.chain?s.chain.slice(0):[]}:{},t,i.value),i.value),Promise.resolve(r(s)).then(t=>null!=t&&t!==k?(s.result=t.result||t,s):o(e,c,t)))}return t.next=o,Promise.resolve().then(()=>o(!0,this.root)).catch(e=>{let t=function(e){let t=`Path '${e.pathname}' is not properly resolved due to an error.`,a=(e.route||{}).path;return a&&(t+=` Resolution had failed on route: '${a}'`),t}(s);if(e?console.warn(t):e=Error(t),e.context=e.context||s,e instanceof DOMException||(e.code=e.code||500),this.errorHandler)return s.result=this.errorHandler(e),s;throw e})}/**
 ...
 *//** @type {Array<NavigationTrigger>} */let D=[];const q=e=>{let t=getComputedStyle(e).getPropertyValue("animation-name");return t&&"none"!==t},V=(e,t)=>{let a=()=>{e.removeEventListener("animationend",a),t()};e.addEventListener("animationend",a)};function J(e,t){return e.classList.add(t),new Promise(a=>{if(q(e)){let r=e.getBoundingClientRect(),i=`height: ${r.bottom-r.top}px; width: ${r.right-r.left}px`;e.setAttribute("style",`position: absolute; ${i}`),V(e,()=>{e.classList.remove(t),e.removeAttribute("style"),a()})}else e.classList.remove(t),a()})}function W({pathname:e="",search:t="",hash:a="",chain:r=[],params:i={},redirectFrom:n,resolver:s},o){let c=r.map(e=>e.route);return{baseUrl:s&&s.baseUrl||"",pathname:e,search:t,hash:a,routes:c,route:o||c.length&&c[c.length-1]||null,params:i,redirectFrom:n,getUrl:(e={})=>X(ee.pathToRegexp.compile(Z(c))(Object.assign({},i,e)),s)}}function G(e,t){let a=Object.assign({},e.params);return{redirect:{pathname:t,from:e.pathname,params:a}}}function K(e,t,a){if(b(e))return e.apply(a,t)}function Q(e,t,a){return r=>r&&(r.cancel||r.redirect)?r:a?K(a[e],t,a):void 0}function Y(e){if(e&&e.length){let t=e[0].parentNode;for(let a=0;a<e.length;a++)t.removeChild(e[a])}}function X(e,t){let a=t.__effectiveBaseUrl;return a?t.constructor.__createUrl(e.replace(/^\//,""),a).pathname:e}function Z(e){return e.map(e=>e.path).reduce((e,t)=>t.length?e.replace(/\/$/,"")+"/"+t.replace(/^\//,""):e,"")}/**
...
for(let t=e.__divergedChainIndex;t<e.chain.length&&this.__isLatestRender(e);t++){let a=e.chain[t].element||{},r=W(e,e.chain[t].route);K(a.onAfterEnter,[r,{},e.resolver],a)}}__animateIfNeeded(e){let t;let a=(this.__disappearingContent||[])[0],r=(this.__appearingContent||[])[0],i=[],n=e.chain;for(let e=n.length;e>0;e--)if(n[e-1].route.animate){t=n[e-1].route.animate;break}if(a&&r&&t){let e=x(t)&&t.leave||"leaving",n=x(t)&&t.enter||"entering";i.push(J(a,e)),i.push(J(r,n))}return Promise.all(i).then(()=>e)}/**
   ...
   *
   * @return {string}
   */urlForName(e,t){return this.__urlForName||(this.__urlForName=function(e,t={}){if(!(e instanceof B))throw TypeError("An instance of Resolver is expected");let a=new Map;return(r,i)=>{let n=I(a,r);if(!n&&(a.clear(),function e(t,a,r){let i=a.name||a.component;if(i&&(t.has(i)?t.get(i).push(a):t.set(i,[a])),Array.isArray(r))for(let i=0;i<r.length;i++){let n=r[i];n.parent=a,e(t,n,n.__children||n.children)}}(a,e.root,e.root.__children),!(n=I(a,r))))throw Error(`Route "${r}" not found`);let s=U.get(n.fullPath);if(!s){let e=F(n),t=n.parent;for(;t;){let a=F(t);a&&(e=a.replace(/\/$/,"")+"/"+e.replace(/^\//,"")),t=t.parent}let a=N.parse(e),r=N.tokensToFunction(a),i=Object.create(null);for(let e=0;e<a.length;e++)_(a[e])||(i[a[e].name]=!0);s={toPath:r,keys:i},U.set(e,s),n.fullPath=e}let o=s.toPath(i,t)||"/";if(t.stringifyQueryParams&&i){let e={},a=Object.keys(i);for(let t=0;t<a.length;t++){let r=a[t];s.keys[r]||(e[r]=i[r])}let r=t.stringifyQueryParams(e);r&&(o+="?"===r.charAt(0)?r:`?${r}`)}return o}}(this)),X(this.__urlForName(e,t),this)}/**
...
this.listeners.push(e)},getState(){return this.data},setDeployedStatus(e){let t=this.getState();t.deployed=e,this.setState(t)},setHeader(e){let t=this.getState();t.actualTabHeader=e,this.setState(t)},setState(e){this.data=e;let t=this.getState();for(let e of this.listeners)e(t)}};class es extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}connectedCallback(){}render(){let e=this.getAttribute("title");var t="",a="Preview tarjeta...";switch(e){case"Sobre Mi":a="Informacion sobre Sebas",t=r("bV7Mj");break;case"Experiencias":a="Experiencias laborales",t=r("3lHJf");break;case"Trabajos":a="Proyectos web",t=r("3vCYr");break;case"Contacto":a="Encontrame en...",t=r("6uJzw")}this.addEventListener("click",()=>{let t=en.getState();if(t.deployed)switch(e){case"Sobre Mi":ee.go("/wpp-clon/about"),en.setHeader("Sobre m\xed");break;case"Experiencias":ee.go("/wpp-clon/experiences"),en.setHeader("Experiencias");break;case"Trabajos":ee.go("/wpp-clon/works"),en.setHeader("Trabajos");break;case"Contacto":ee.go("/wpp-clon/contact"),en.setHeader("Contacto")}if(!t.deployed)switch(e){case"Sobre Mi":ee.go("/about"),en.setHeader("Sobre m\xed");break;case"Experiencias":ee.go("/experiences"),en.setHeader("Experiencias");break;case"Trabajos":ee.go("/works"),en.setHeader("Trabajos");break;case"Contacto":ee.go("/contact"),en.setHeader("Contacto")}}),this.shadow.innerHTML=`
      ...
      `,this.shadow.appendChild(i)}}customElements.define("chat-card",es);class eo extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.headerTitle="Sobre m\xed",this.render()}connectedCallback(){en.subscribe(e=>{this.headerTitle=e.actualTabHeader,this.render()})}render(){let e=document.createElement("style");var t="";switch(this.headerTitle){case"Sobre m\xed":t=r("bV7Mj");break;case"Experiencias":t=r("3lHJf");break;case"Trabajos":t=r("3vCYr");break;case"Contacto":t=r("6uJzw")}this.shadow.innerHTML=`
            <div class="header">
      ...
      `,this.shadow.appendChild(e)}}customElements.define("chat-header",eo);const ec=new ee(document.querySelector(".main__container")),el=window.location.origin;el.startsWith("http://localhost")?(en.setDeployedStatus(!1),ec.setRoutes([{path:"/",component:"home-page"},{path:"/about",component:"about-page"},{path:"/experiences",component:"exp-page"},{path:"/works",component:"works-page"},{path:"/contact",component:"contact-page"}])):(en.setDeployedStatus(!0),ec.setRoutes([{path:"/wpp-clon/",component:"about-page"},{path:"/wpp-clon/about",component:"about-page"},{path:"/wpp-clon/experiences",component:"exp-page"},{path:"/wpp-clon/works",component:"works-page"},{path:"/wpp-clon/contact",component:"contact-page"}])),(()=>{document.addEventListener("keydown",e=>{let t=en.getState();if("Escape"==e.key)switch(t.deployed){case!0:ee.go("/wpp-clon/");break;case!1:ee.go("/")}});let e=document.querySelector(".icons__close");e.addEventListener("click",()=>{let e=en.getState();switch(e.deployed){case!0:ee.go("/wpp-clon/");break;case!1:ee.go("/")}}),console.log("Index HOLA")})();//# sourceMappingURL=index.f4ce4d4f.js.map

//# sourceMappingURL=index.f4ce4d4f.js.map
