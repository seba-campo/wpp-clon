var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},t={},a={},r=e.parcelRequire6c15;null==r&&((r=function(e){if(e in t)return t[e].exports;if(e in a){var r=a[e];delete a[e];var i={id:e,exports:{}};return t[e]=i,r.call(i.exports,i,i.exports),i.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){a[e]=t},e.parcelRequire6c15=r),r.register("gPNMe",function(e,t){e.exports=new URL(r("27Lyk").resolve("dCh8C"),import.meta.url).toString()}),r.register("bV7Mj",function(e,t){e.exports=new URL(r("27Lyk").resolve("dTl3G"),import.meta.url).toString()}),r.register("6DNN2",function(e,t){e.exports=new URL(r("27Lyk").resolve("kQqv5"),import.meta.url).toString()}),r.register("3lHJf",function(e,t){e.exports=new URL(r("27Lyk").resolve("458Cq"),import.meta.url).toString()}),r.register("3vCYr",function(e,t){e.exports=new URL(r("27Lyk").resolve("iKwvN"),import.meta.url).toString()}),r.register("6uJzw",function(e,t){e.exports=new URL(r("27Lyk").resolve("8op45"),import.meta.url).toString()});class i extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}connectedCallback(){}render(){let e=r("gPNMe"),t=r("bV7Mj"),a=r("6DNN2");this.shadow.innerHTML=`
      ...
      `,this.shadow.appendChild(t)}}customElements.define("contact-page",o);class c extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}connectedCallback(){}render(){this.shadow.innerHTML=`
      <div class="chat-root-div">
      </div>
 ...
 * @param  {Object=} options
 * @return {!RegExp}
 */function(t,a,r){for(var i=[],n=0;n<t.length;n++)i.push(e(t[n],a,r).source);return RegExp("(?:"+i.join("|")+")",j(r))}(/** @type {!Array} */t,a,r):A(H(/** @type {string} */t,r),a,r)},M=RegExp("(\\\\.)|(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?","g");/**
 * Parse a string for the raw tokens.
 *
 * @param  {string}  str
 * @param  {Object=} options
 * @return {!Array}
 */function H(e,t){for(var a,r=[],i=0,n=0,s="",o=t&&t.delimiter||"/",c=t&&t.delimiters||"./",l=!1;null!==(a=M.exec(e));){var d=a[0],p=a[1],h=a.index;// Ignore already escaped sequences.
if(s+=e.slice(n,h),n=h+d.length,p){s+=p[1],l=!0;continue}var m="",g=e[n],u=a[2],v=a[3],f=a[4],w=a[5];if(!l&&s.length){var x=s.length-1;c.indexOf(s[x])>-1&&(m=s[x],s=s.slice(0,x))}s&&(r.push(s),s="",l=!1);var b=""!==m&&void 0!==g&&g!==m,_="+"===w||"*"===w,y="?"===w||"*"===w,k=m||o,C=v||f;r.push({name:u||i++,prefix:m,delimiter:k,optional:y,repeat:_,partial:b,pattern:C?C.replace(/([=!:$/()])/g,"\\$1"):"[^"+T(k)+"]+?"})}return(s||n<e.length)&&r.push(s+e.substr(n)),r}/**
...
for(var r=(a=a||{}).strict,i=!1!==a.start,n=!1!==a.end,s=T(a.delimiter||"/"),o=a.delimiters||"./",c=[].concat(a.endsWith||[]).map(T).concat("$").join("|"),l=i?"^":"",d=0===e.length,p=0;p<e.length;p++){var h=e[p];if("string"==typeof h)l+=T(h),d=p===e.length-1&&o.indexOf(h[h.length-1])>-1;else{var m=h.repeat?"(?:"+h.pattern+")(?:"+T(h.delimiter)+"(?:"+h.pattern+"))*":h.pattern;t&&t.push(h),h.optional?h.partial?l+=T(h.prefix)+"("+m+")?":l+="(?:"+T(h.prefix)+"("+m+"))?":l+=T(h.prefix)+"("+m+")"}}return n?(r||(l+="(?:"+s+")?"),l+="$"===c?"$":"(?="+c+")"):(r||(l+="(?:"+s+"(?="+c+"))?"),d||(l+="(?="+s+"|"+c+")")),new RegExp(l,j(a))}z.parse=H,z.compile=/**
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE.txt file in the root directory of this source tree.
 */const{pathToRegexp:N}=B,I=new Map;function U(e,t){let a=e.get(t);if(a&&a.length>1)throw Error(`Duplicate route with name "${t}". Try seting unique 'name' route properties.`);return a&&a[0]}function F(e){let t=e.path;return void 0!==(t=Array.isArray(t)?t[0]:t)?t:""}/**
...
for(let t=e.__divergedChainIndex;t<e.chain.length&&this.__isLatestRender(e);t++){let a=e.chain[t].element||{},r=W(e,e.chain[t].route);K(a.onAfterEnter,[r,{},e.resolver],a)}}__animateIfNeeded(e){let t;let a=(this.__disappearingContent||[])[0],r=(this.__appearingContent||[])[0],i=[],n=e.chain;for(let e=n.length;e>0;e--)if(n[e-1].route.animate){t=n[e-1].route.animate;break}if(a&&r&&t){let e=x(t)&&t.leave||"leaving",n=x(t)&&t.enter||"entering";i.push(J(a,e)),i.push(J(r,n))}return Promise.all(i).then(()=>e)}/**
   ...
   *
   * @return {string}
   */urlForName(e,t){return this.__urlForName||(this.__urlForName=function(e,t={}){if(!(e instanceof B))throw TypeError("An instance of Resolver is expected");let a=new Map;return(r,i)=>{let n=U(a,r);if(!n&&(a.clear(),function e(t,a,r){let i=a.name||a.component;if(i&&(t.has(i)?t.get(i).push(a):t.set(i,[a])),Array.isArray(r))for(let i=0;i<r.length;i++){let n=r[i];n.parent=a,e(t,n,n.__children||n.children)}}(a,e.root,e.root.__children),!(n=U(a,r))))throw Error(`Route "${r}" not found`);let s=I.get(n.fullPath);if(!s){let e=F(n),t=n.parent;for(;t;){let a=F(t);a&&(e=a.replace(/\/$/,"")+"/"+e.replace(/^\//,"")),t=t.parent}let a=N.parse(e),r=N.tokensToFunction(a),i=Object.create(null);for(let e=0;e<a.length;e++)_(a[e])||(i[a[e].name]=!0);s={toPath:r,keys:i},I.set(e,s),n.fullPath=e}let o=s.toPath(i,t)||"/";if(t.stringifyQueryParams&&i){let e={},a=Object.keys(i);for(let t=0;t<a.length;t++){let r=a[t];s.keys[r]||(e[r]=i[r])}let r=t.stringifyQueryParams(e);r&&(o+="?"===r.charAt(0)?r:`?${r}`)}return o}}(this)),X(this.__urlForName(e,t),this)}/**
